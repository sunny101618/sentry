...
class MailAdapterGetSendToOwnersTest(BaseMailAdapterTest, TestCase):
    ...
    def test_disable_alerts_user_scope(self):
        ...
        assert self.user2 not in get_send_to_owners(event_all_users, self.project)
...
class MailAdapterGetSendToTeamTest(BaseMailAdapterTest, TestCase):
    ...
    def test_send_disabled(self):
        ...
        assert set() == get_send_to_team(self.project, str(self.team.id))

    def test_invalid_team(self):
        assert set() == get_send_to_team(self.project, "900001")
    ...
    def test_other_project_team(self):
        ...
        assert {user_2} == get_send_to_team(project_2, str(team_2.id))
        assert set() == get_send_to_team(self.project, str(team_2.id))
...
class MailAdapterGetSendToMemberTest(BaseMailAdapterTest, TestCase):
    ...
    def test_invalid_user(self):
        assert set() == get_send_to_member(self.project, "900001")
    ...
    def test_other_org_user(self):
        ...
        assert {user_2} == get_send_to_member(project_2, str(user_2.id))
        assert set() == get_send_to_member(self.project, str(user_2.id))
    ...
    def test_no_project_access(self):
        ...
        project_2 = self.create_project(organization=org_2, teams=[team_2])
        assert {user_2} == get_send_to_member(project_2, str(user_2.id))
        assert set() == get_send_to_member(self.project, str(user_3.id))
